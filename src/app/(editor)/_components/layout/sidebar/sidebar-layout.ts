export const GUITAR_LAYOUT = [
  {
    ...
    colors: [
      ...
      },
      {
        key: "sustain_open",
        label: "Open Sustain",
        description: "Sustain trail color for open notes.",
      },
    ],
  },
  {
...
export const OTHER_LAYOUT = [
  ...
  {
    groupName: "Note Hit Effects",
    colors: [
      {
        key: "striker_hit_flame",
        label: "Hit Flame",
        description: "Color of the flame from a regular note hit.",
      },
      {
      ...
      },
      {
        ...
        label: "Open Note Hit Flame",
        description: "Color of the expansive effect from hitting an open note.",
      },
      {
        key: "striker_hold_spark",
        label: "Sustain Spark",
      ...
      },
      {
        ...
        label: "SP Hit Flame",
        description: "Color of hit flames when Star Power is active.",
      },
      {
        key: "striker_hit_particles_sp_active",
        label: "SP Hit Particles",
        description: "Color of hit particles when Star Power is active.",
      },
      {
        key: "striker_hold_spark_sp_active",
  ...
  },
  {
    ...
    colors: [
      ...
      {
        key: "sp_bar_elec",
        label: "SP Meter Electricity",
        description: "Color of the electrical effect inside the SP bar.",
      },
      {
        key: "sp_bar_arrow",
